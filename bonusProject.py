...
def usd_to_ils():
    from projectClassUSD import USD  # calling our class of currency and using our api function to get up-to-date result
    usd = USD.live_currency()
    return usd


def ils_to_usd():
    from projectClassILS import ILS  # calling our class of currency and using our api function to get up-to-date result
    ils = ILS.live_currency()
    return ils


def ils_to_eur():
    from projectClassEUR import EUR  # calling our class of currency and using our api function to get up-to-date result
    eur = EUR.live_currency()
    return eur


def get_user_value():
    from projectClassUSD import USD  # importing our class of currency
    from projectClassILS import ILS
    from projectClassEUR import EUR
...
def tkinter():
    ...
    file = open('C:/Users/nadav2022/PycharmProjects/pythonFIRSTProject/results_list.txt', 'r')
